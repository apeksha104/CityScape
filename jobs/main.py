...
def simulate_journey(producer, device_id):
    while True:
        ...
        if (
            ...
            print("Vehicle has reached Birmingham. Exiting simulation.")
            break
        ...
        time.sleep(5)  # wait for 5 second before generating new data
...
if __name__ == "__main__":
    ...
    try:
        simulate_journey(producer, "Vehicle-DataCity-123")
